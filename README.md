...
Due to beta, crack needs an internet connection and a demo license. 
I recommend you use it in VM and VPN. Because DevX sends these to server:
...
Installation
-------------
Beta version of crack requires a demo license, and an internet connection
On first run, crack will ask you to setup PC name. It is already autogenerated, but you can make it a bit more real, however DON'T use your real PC name in it.
If you already have one, reissue it and use it in crack.
If you don't, use a VPN to make new one, and use the same VPN when you use the program.
